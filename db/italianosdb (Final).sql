...
(17, 'gal_20181122185445.jpg', 'Auditório no Sincomercio durante o Seminário', '<p>Audit&oacute;rio no Sincomercio durante o I Semin&aacute;rio sobre a Imigra&ccedil;&atilde;o Italiana em Itu</p>'),
(18, 'gal_20181122185527.jpg', 'Público no auditório do Sincomercio durante o Seminário', '<p>P&uacute;blico no audit&oacute;rio no Sincomercio durante o I Semin&aacute;rio sobre a Imigra&ccedil;&atilde;o Italiana em Itu.</p>'),
(19, 'gal_20181122185607.jpg', 'Público no auditório do Sincomercio durante o Seminário', '<p style=\"box-sizing: border-box; margin-top: 0px; margin-bottom: 1rem;\">P&uacute;blico no audit&oacute;rio no Sincomercio durante o I Semin&aacute;rio sobre a Imigra&ccedil;&atilde;o Italiana em Itu.</p>'),
(20, 'gal_20181122185857.jpg', 'Convidados no Sincomercio durante o Seminário', ''),
(21, 'gal_20181122190022.jpg', 'Alunas do curso de Secretariado durante o Seminário', '<p>Alunas do curso de Secretariado da ETEC Martinho Di Ciero, respons&aacute;veis pela recep&ccedil;&atilde;o e pelo acolhedor atendimento durante o Semin&aacute;rio.</p>'),
(22, 'gal_20181122190128.jpg', 'I Seminário sobre a Imigração Italiana em Itu', ''),
(23, 'gal_20181122190140.jpg', 'I Seminário sobre a Imigração Italiana em Itu', ''),
(24, 'gal_20181122190244.jpg', 'Organizadora Vilma Pavão no Seminário', '<p>Organizadora Vilma Pav&atilde;o no I Semin&aacute;rio sobre a Imigra&ccedil;&atilde;o Italiana em Itu.</p>'),
(25, 'gal_20181122190336.jpg', 'Organizadores no I Seminário sobre a Imigração Italiana em Itu', ''),
(26, 'gal_20181122190358.jpg', 'Público do I Seminário sobre a Imigração Italiana em Itu', '');
...
(3, 'Eloísa Carvalho', 'Convite para o lançamento do segundo volume do livro Italianos em Itu: da Imigração à Atualidade', '', '2018-11-18', '20:57:59', 'eve_20181118213109.png', 'eve', 0);
...
--
ALTER TABLE `galeria`
  MODIFY `gal_cod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
